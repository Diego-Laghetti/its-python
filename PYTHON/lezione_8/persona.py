class Persona:
    ...
    # _call_ non deve necessarimanete printare o ritornare un valore. Ritorna un valore se tale valore deve essere riutilizzato nel codice. 
    # printa un valore se il metodo deve eseguire un'azione senza dover restituire nulla
    # Ovviamente, il metodo _call_ può ricevere parametri in input e parametri con valori di default.
