#genero la chiave pubblica a partire da quella privata: openssl rsa -in FAprivkey.pem -out FApubkey.pem -pubout -RSAPublicKey_out

#leggo la chiave privata: openssl rsa -in FAprivkey.pem -noout -text

#leggo la chiave pubblica: openssl rsa -in FApubkey.pem -pubin -noout -text

#modulo terminale del mio bro
...
#esponente terminale del mio bro
e = 65537
...
#esponente privato in esadecimale mio
